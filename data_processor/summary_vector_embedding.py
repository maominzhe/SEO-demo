...
def create_table_if_not_exists(conn, cur):
    cur.execute("""
        CREATE TABLE IF NOT EXISTS summary_vector_embeddings (
...
def encode_summary_and_save_vector(conn,cur):
...
if __name__ == "__main__":
    ...
    encode_summary_and_save_vector(conn,cur)
    cur.close()
    conn.close()